...
const TermsAndConditions = ({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Save Status */}
      {saveStatus && (
        <div className={`p-3 rounded-lg ${saveStatus.includes('success')
      ...
      {editMode ? (
            ...
            {policy.points.length === 0 ? (
              ...
              <div className="space-y-4">
                {policy.points.map((point, index) => (
                  <div key={point.point_id} className="border rounded-lg p-4 bg-white">
                    {editingPoint && editingPoint.point_id === point.point_id ? (
                      ...
                      <>
                        ...
                        <p className="text-gray-700 whitespace-pre-line">{point.point_description}</p>
                      </>
                    )}
                  </div>
                ))}
        ...
        <div className="prose max-w-none">
          <div className="bg-gray-50 p-6 rounded-lg">
            {policy.points.map((point, index) => (
              <div key={point.point_id} className="mb-6 last:mb-0">
