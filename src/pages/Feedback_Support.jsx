      ...
      {stats.overview && (
        <div className="grid grid-cols-2 md:grid-cols-6 gap-4 mb-6">
          <div className="bg-white p-4 rounded-lg shadow">
            <div className="text-2xl font-bold text-blue-600">{stats.overview.total_tickets || 0}</div>
            <div className="text-sm text-gray-600">Total Tickets</div>
          </div>
          <div className="bg-white p-4 rounded-lg shadow">
            <div className="text-2xl font-bold text-yellow-600">{stats.status_distribution?.pending || 0}</div>
            <div className="text-sm text-gray-600">Pending</div>
          </div>
          <div className="bg-white p-4 rounded-lg shadow">
            <div className="text-2xl font-bold text-blue-600">{stats.status_distribution?.in_progress || 0}</div>
            <div className="text-sm text-gray-600">In Progress</div>
          </div>
          <div className="bg-white p-4 rounded-lg shadow">
            <div className="text-2xl font-bold text-green-600">{stats.status_distribution?.resolved || 0}</div>
            <div className="text-sm text-gray-600">Resolved</div>
          </div>
          <div className="bg-white p-4 rounded-lg shadow">
            <div className="text-2xl font-bold text-red-600">{stats.priority_distribution?.urgent || 0}</div>
            <div className="text-sm text-gray-600">Urgent</div>
          </div>
          <div className="bg-white p-4 rounded-lg shadow">
            <div className="text-2xl font-bold text-orange-600">{stats.priority_distribution?.high || 0}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="rounded"
            />
            <label htmlFor="include_deleted" className="text-sm text-gray-700">
              Include Deleted
            </label>
          </div>
        </div>
        ...
        <div className="flex justify-center items-center gap-2 mt-6">
          ...
          {Array.from({ length: pagination.total_pages }, (_, i) => i + 1).map(page => (
            <button
              ...
              className={`px-3 py-2 rounded-lg ${page === pagination.current_page
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-semibold">Update Ticket Status</h3>
              <button
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <div className="mt-1 text-sm">{selectedTicket.ticket_info?.description || 'N/A'}</div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <div className="mt-1 text-sm">{categoryConfig[selectedTicket.ticket_info?.category_id] || 'N/A'}</div>
                    </div>
                    <div>
